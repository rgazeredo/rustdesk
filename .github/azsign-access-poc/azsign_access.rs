...
#[derive(Deserialize)]
struct Enrollment { identity_id: String, profile: Profile, certificate_base64: String, ca_base64: String }
...
pub async fn tcp(target: &str, milliseconds: u64) -> ResultType<crate::Stream> {
    let service = match target {
        "127.0.0.1:21116" | "rustdesk.azsign.com.br:21116" => "rendezvous",
        // The private lab server still advertises its logical relay alias.
        "127.0.0.1:21117" | "azsign-poc.invalid:21117" | "rustdesk.azsign.com.br:21117" => "relay",
...
pub async fn udp(target: &str, milliseconds: u64) -> ResultType<(crate::udp::FramedSocket, crate::TargetAddr<'static>)> {
    if target != "127.0.0.1:21116" && target != "rustdesk.azsign.com.br:21116" { bail!("PoC forbids direct/public UDP targets"); }
